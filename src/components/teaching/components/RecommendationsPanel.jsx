...
/**
 * RecommendationsPanel - Componente de panel de recomendaciones
 *
 * Muestra recomendaciones inteligentes personalizadas basadas en el progreso.
 *
 * @param {Array} recommendations - Array de recomendaciones generadas
 * @returns {JSX.Element} Componente de panel de recomendaciones
 */
