/**
 * Exportaciones centralizadas de los componentes de progreso gamificado
 */
...
export { default as BossFightCard } from './BossFightCard';
export { default as ComprehensionPanel } from './ComprehensionPanel';
export { default as FeedbackStrip } from './FeedbackStrip';
export { default as LeaderboardCompact } from './LeaderboardCompact';
