...
import { updateLessonProgress } from '@/features/progress/services/progressService';
import {
  generateClientEventId,
  addToOutbox,
  removeFromOutbox,
  markAsConfirmed,
} from '@/shared/utils/progressOutbox';
import {
  calculateOptimisticProgress,
  createDefaultLessonProgress,
  inferModuleIdFromLesson,
} from '../utils/progressHelpers';
import { RETRY_DELAY_MS, MAX_RETRIES } from '../utils/constants';
