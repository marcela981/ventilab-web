...
import { PARAMETER_UNITS } from '@/features/simulador/compartido/constantes/ventilator-limits';
import type { VentilatorData, VentilationMode } from '@/features/simulador/compartido/tipos/simulator.types';
