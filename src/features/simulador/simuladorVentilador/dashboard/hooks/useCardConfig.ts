...
import { DEFAULT_CARD_CONFIG } from '@/features/simulador/compartido/constantes/ventilator-limits';
import type { CardConfigItem, VentilationMode } from '@/features/simulador/compartido/tipos/simulator.types';
