 ...
 *              Estilos en WarmupOverlay.css (sin MUI sx ni estilos inline).
 * Versión: 1.0
  ...
  return (
    ...
    >
      <div className="warmup-card">
        <div className="warmup-logo" aria-hidden="true">VL</div>

        <div className="warmup-spinner" aria-hidden="true" />

        <p className="warmup-title">Conectando con el servidor</p>

        <p className="warmup-message">
