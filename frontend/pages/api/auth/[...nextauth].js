        ...
        if (account?.provider === 'google') {
          ...
          if (existingUser) {
            if (!existingUser.isActive) {
              console.error('[NextAuth] Inactive user attempted login:', user.email);
          ...
          // with default role STUDENT and isActive true
        }

        // For credentials provider
        if (account?.provider === 'credentials') {
          // Additional checks already done in authorize() function
          // Just verify isActive status
