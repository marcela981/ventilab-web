/**
 * Progress DTOs (Data Transfer Objects)
 * 
 * These types define the contract between frontend and backend for progress-related APIs.
 * They represent the exact shape of data returned by the progress endpoints.
 * 
 * All dates are serialized as ISO 8601 strings in JSON responses.
 */
...
/**
 * Type guard to check if a value is a valid progress value (0-1)
 */
...
/**
 * Type guard to check if a value is a valid progress percentage (0-100)
 */
...
/**
 * Convert progress value (0-1) to percentage (0-100)
 */
...
/**
 * Convert progress percentage (0-100) to value (0-1)
 */
export function percentageToProgress(percentage: number): number {
